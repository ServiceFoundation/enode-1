...
public class CommandAndEventServiceTest extends AbstractTest {
    ...
    public void create_and_update_aggregate_test() {
        ...
        asyncResult = await(_commandService.executeAsync(command2));
        Assert.assertNotNull(asyncResult);
        Assert.assertEquals(AsyncTaskStatus.Success, asyncResult.getStatus());
    ...
    public void create_and_update_inherit_aggregate_test() {
        ...
        Assert.assertNotNull(commandResult);
        Assert.assertEquals(CommandStatus.Success, commandResult.getStatus());
        InheritTestAggregate note = await(_memoryCache.getAsync(aggregateId, InheritTestAggregate.class));
        Assert.assertNotNull(note);
        Assert.assertEquals("Sample Note", note.getTitle());
        Assert.assertEquals(1, note.getVersion());
        //执行修改聚合根的命令
        ...
        Assert.assertNotNull(commandResult);
        Assert.assertEquals(CommandStatus.Success, commandResult.getStatus());
        note = await(_memoryCache.getAsync(aggregateId, InheritTestAggregate.class));
        Assert.assertNotNull(note);
        Assert.assertEquals("Changed Note", note.getTitle());
        Assert.assertEquals(2, note.getVersion());
    }
    ...
    public void command_sync_execute_test() {
        ...
        //执行创建聚合根的命令
        AsyncTaskResult<CommandResult> commandResult = await(_commandService.executeAsync(command));
        Assert.assertNotNull(commandResult);
    ...
    public void duplicate_update_aggregate_command_test() {
        ...
        //先创建一个聚合根
        CommandStatus status = await(_commandService.executeAsync(command1)).getData().getStatus();
        Assert.assertEquals(CommandStatus.Success, status);
        ChangeTestAggregateTitleCommand command2 = new ChangeTestAggregateTitleCommand();
        command2.aggregateRootId = aggregateId;
        command2.setTitle("Changed Note");
        //执行修改聚合根的命令
        AsyncTaskResult<CommandResult> asyncResult = await(_commandService.executeAsync(command2, CommandReturnType.EventHandled));
        Assert.assertNotNull(asyncResult);
        Assert.assertEquals(AsyncTaskStatus.Success, asyncResult.getStatus());
        CommandResult commandResult = asyncResult.getData();
        Assert.assertNotNull(commandResult);
        ...
        for (int i = 0; i < totalCount; i++) {
            ...
            _commandService.executeAsync(updateCommand).thenAccept(result ->
            {
                ...
                if (current == totalCount) {
                    TestAggregate note1 = await(_memoryCache.getAsync(aggregateId, TestAggregate.class));
    ...
    public void set_result_command_test() {
        ...
        AsyncTaskResult<CommandResult> asyncResult = await(_commandService.executeAsync(command, CommandReturnType.EventHandled));
        Assert.assertNotNull(asyncResult);
        Assert.assertEquals(AsyncTaskStatus.Success, asyncResult.getStatus());
        CommandResult commandResult = asyncResult.getData();
        Assert.assertNotNull(commandResult);
    ...
    public void change_multiple_aggregates_test() {
        ...
        AsyncTaskResult<CommandResult> asyncResult = await(_commandService.executeAsync(command3));
        Assert.assertNotNull(asyncResult);
        Assert.assertEquals(AsyncTaskStatus.Success, asyncResult.getStatus());
        CommandResult commandResult = asyncResult.getData();
        Assert.assertNotNull(commandResult);
    ...
    public void aggregate_throw_exception_command_test() {
        ...
        AsyncTaskResult<CommandResult> asyncResult = await(_commandService.executeAsync(command1));
        Assert.assertNotNull(asyncResult);
        Assert.assertEquals(AsyncTaskStatus.Success, asyncResult.getStatus());
        CommandResult commandResult = asyncResult.getData();
        Assert.assertNotNull(commandResult);
    ...
    public void async_command_handler_throw_exception_test() {
        ...
        asyncResult = await(_commandService.executeAsync(command1));
        Assert.assertNotNull(asyncResult);
        Assert.assertEquals(AsyncTaskStatus.Success, asyncResult.getStatus());
        commandResult = asyncResult.getData();
        Assert.assertNotNull(commandResult);
    ...
    public void event_handler_priority_test() {
        ...
        CommandResult commandResult1 = await(_commandService.executeAsync(command1, CommandReturnType.EventHandled)).getData();
        CommandResult commandResult2 = await(_commandService.executeAsync(command2, CommandReturnType.EventHandled)).getData();
        Task.sleep(3000);
